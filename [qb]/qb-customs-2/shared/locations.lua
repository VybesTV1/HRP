...
Config.Locations = {
    ['Innocence'] = {
        ...
        zones = {
            { coords = vector3(-2033.75, 3197.14, 32.55), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-2035.90, 3191.17, 32.55), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
        }
    },
}