...
Config.CoreName = 'qb-core' -- Your core resource name qbx-core, qb-core, es_extended
Config.Inventory = 'qb-inventory' -- Your inventory resource folder name ox_inventory, qb-inventory, ...
Config.Target = 'qb-target' -- Your target resource name ox_target, qb-target, ...
