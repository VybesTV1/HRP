    ...
    fruitBuyers = {
        {
            ...
            items = {
                ['apple'] = {label = 'Apple', sale = 2, multiple = true, icon = '',},
                ['orange'] = {label = 'Orange', sale = 2, multiple = true, icon = '',},
                ['potato'] = {label = 'Potato', sale = 2, multiple = true, icon = '',},
                ['tomato'] = {label = 'Tomato', sale = 2, multiple = true, icon = '',},
                ['pineapple'] = {label = 'Pineapple', sale = 2, multiple = true, icon = ''},
                ['strawberry'] = {label = 'Strawberry', sale = 2, multiple = true, icon = ''},
                ['pumpkin'] = {label = 'Pumpkin', sale = 2, multiple = true, icon = ''},
            },
        }
    },
