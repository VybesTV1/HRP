...
function IsSmokeStillActive(id)
    return smoke[id] ~= nil
end

exports("IsSmokeStillActive", IsSmokeStillActive)
...
-- This event allows you to receive data on any new fires
RegisterServerEvent("Server:newFireEvent")
AddEventHandler("Server:newFireEvent", function(id, coords, size)
