main = {
    commandName = "rescuecushion", -- If item is enabled, command will only remove the rescue cushion once you have used the item.
    itemEnabled = false,
...
translations = {
    ...
    placingCushion = "Prese ENTER to finish Rescue Cushion placement",
}
