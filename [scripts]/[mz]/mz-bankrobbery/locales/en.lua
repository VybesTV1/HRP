local Translations = {
    ...
    error = {
        ...
        bank_already_open = "The bank security has already been breached...",
    ...
    general = {
        ...
        steal_from_safe = "Searching through lockbox...",
        connecting_hacking_device = "Installing chipset override...",
        load_hack = "Loading trojan_breach.exe...",
        plug_usb = "Plugging in bypass driver...",
        bypass_terminal = "Bypass security clearance...",
